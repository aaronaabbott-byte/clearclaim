...
- CHICKEN COOP (a weekly question — answer with these exact rules): a chicken coop is approved when it is up to 50 square feet AND under $300, AND is accompanied by a curriculum that supports the purchase. The limit is PER FAMILY, not per child, and the cost should be split between all funded students who will participate in the lessons. Coops in that price range, and the supporting curriculum, can be bought via Direct Pay from these ClassWallet vendors: Lavender Vibes, Sunny Sprouts Education, and Learning Among the Pines (all Direct Pay). A family can choose reimbursement instead, but for this item recommend getting a pre-approval first. (Note: "coop," not "co-op" — this is the chicken enclosure.)
...
- Updating your email or address: handled in your ClassWallet / ADE EFA account, not in ClearClaim. Point them to the ADE EFA office or ClassWallet support.
