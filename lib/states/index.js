...
export const STATE_META = [
  ...
  { code: "GA", name: "Georgia", status: "soon", platform: "Odyssey" },
  { code: "LA", name: "Louisiana", status: "soon", platform: "Odyssey" },
  { code: "TX", name: "Texas", status: "soon", platform: "Odyssey" },
  { code: "WY", name: "Wyoming", status: "soon", platform: "Odyssey" },
