...
export function checkClaim(c) {
  ...
  if (cat.includes("travel") || cat.includes("mileage") || cat.includes("transportation")) {
    push("warn", `Transportation to and from an approved school, tutor, therapy, or in-state activity is reimbursed at $${FUNDING.mileageRate}/mile and draws from the 25% transportation cap (~$${CAP_25}/student). Attach a completed mileage log with dates, destinations, and miles.`);
  }
