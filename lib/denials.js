...
const RULES = [
  ...
  },
  {
    ...
    level: "fixable",
    test: /proof of enrollment|proof of (?:course )?participation|enrollment (?:in|for)|lesson participation|enrolled in|class registration|registration (?:for|confirmation)|musical instrument|\bguitar\b|\bpiano\b|\bviolin\b|\bukulele\b|\bcello\b|\bdrum\b|\bbanjo\b|instrument.*(?:lesson|class)|(?:lesson|class).*instrument/i,
    title: "Needs proof of enrollment / lesson participation",
    fix: "Take a screenshot or download your proof of enrollment or lesson participation — the class/lesson registration, a receipt or confirmation from the teacher or studio, or the lesson schedule — then attach it to the claim under \"Other supporting documents.\" For a musical instrument, this proof is required.",
  },
  {
    ...
    fix: "Attach the curriculum or course that uses this item under \"Other supporting documents,\" and write a short, specific educational-use note: name the course/subject, what the student will learn or master with it, and how. Many items (animal enclosures, garden beds, tools, tech) are approved only when a curriculum backs them up.",
  },
  {
    id: "wrong_category",
    level: "fixable",
  ...
  },
  {
    id: "theater",
    level: "ineligible",
    test: /(theater|theatre).*(performance|show|play|ticket|production|musical|admission|live)|live\s+(theater|theatre)|play tickets|\bbroadway\b|\bmatinee\b/i,
    title: "Theater performance",
    fix: "Theater performances, including live theater, are no longer reimbursable in Arkansas — tickets and admission to plays, musicals, and productions won't be reimbursed no matter how it's resubmitted. (A student's own drama/theater class is a separate question.)",
  },
  {
    id: "internet_service",
    level: "ineligible",
