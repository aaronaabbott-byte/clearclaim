...
export const EXCLUSIONS = [
  ...
  {
    id: "theater_performance",
    label: "Theater performances",
    citation: "35-115",
    reason: "Theater performances, including live theater, are no longer reimbursable in Arkansas — attending plays, musicals, and productions (tickets/admission) does not qualify. (A student's own drama or theater class is a separate question.)",
    keywords: ["theater performance", "theatre performance", "live theater", "live theatre", "play ticket", "theater ticket", "theatre ticket", "theater admission", "theatre admission", "broadway", "matinee", "see a play", "attend a play"],
  },
  {
