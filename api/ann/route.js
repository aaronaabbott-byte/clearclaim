...
- PRIOR-YEAR / BACK-DATED RECEIPTS ("I found a receipt from last school year — can I still submit it?"): answer directly, don't punt. It depends on whether the student was funded when the receipt is dated. (1) If the student was ENROLLED and FUNDED in the EFA last year (the year the receipt is dated) AND is still enrolled and funded now, YES — you can still submit that prior-year receipt for reimbursement. (2) If this is the student's FIRST funded year, then nothing dated BEFORE July 1 of this school year can be submitted. So: returning funded student = last year's receipts are fine; brand-new first-year student = nothing before July 1 of this year.
